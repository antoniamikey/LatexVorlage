...
\RedeclareSectionCommand[beforeskip=0.5\baselineskip,afterskip=0.5\baselineskip]{section}
\RedeclareSectionCommand[beforeskip=0.5\baselineskip,afterskip=0.3\baselineskip]{subsection}
...
\setlength{\intextsep}{5pt plus 2pt minus 2pt}   % Abstand zwischen Text und Abbildung
\setlength{\textfloatsep}{5pt plus 2pt minus 2pt} % Abstand zwischen Abbildung und Text
\setlength{\floatsep}{5pt plus 2pt minus 2pt}     % Abstand zwischen zwei Abbildungen
...
% DOI, ISBN und URL als normalen Text (Times New Roman)
...
\lstset{
  float=htbp,
  basicstyle=\sffamily\small, % serifenlose Schrift
  ...
  escapeinside={(*}{*)},
  literate={µ}{\textmu}1 {\$}{{\textdollar}}1,
