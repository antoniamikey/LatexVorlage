...
% Eigene Labels für Anhang-Referenzen definieren
\makeatletter
\newcommand{\setanhanglabel}[2]{%
    \@namedef{r@#1}{{#2}{}{}{}{}}%
}
\makeatother

% % Anhang-Labels definieren
% \setanhanglabel{app:antrag}{A}
% \setanhanglabel{app:istprozess}{B}
% \setanhanglabel{app:sollprozess}{C}
% \setanhanglabel{app:antragsformular}{D}
% \setanhanglabel{app:antragsuebersicht}{E}
% \setanhanglabel{app:detailansicht}{F}
% \setanhanglabel{app:erm}{G}
% \setanhanglabel{app:datenbankschema}{H}
