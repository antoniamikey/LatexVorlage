...
% Beispiel für Zitationen
\chapter{Beispiel für Zitationen}

Hier ist ein Beispieltext mit verschiedenen Zitationsformen:

\section{Direkte Zitation}
Wie \Autor{mustermann2023} in seinem Grundlagenwerk beschreibt, ist ``die korrekte Zitation eine der wichtigsten Grundlagen wissenschaftlichen Arbeitens'' \Zitat{mustermann2023}{42}.

\section{Indirekte Zitation}
Bei der Erstellung einer wissenschaftlichen Arbeit müssen verschiedene Formalia beachtet werden \VglZitat{mustermann2023}{15}. Dabei spielt besonders die einheitliche Formatierung eine wichtige Rolle.

\section{Verschiedene Zitierstile}
Es gibt mehrere Möglichkeiten zu zitieren:
\begin{itemize}
    \item Autor im Text mit Seitenzahl: \Autor{mustermann2023} betont die Wichtigkeit von Quellenangaben \Zitat{mustermann2023}{18}.
    \item Nur die Quelle in Klammern: Die Formatierung sollte einheitlich sein \Zitat{mustermann2023}{25}.
    \item Mit Vergleichsverweis: Weitere Details zu diesem Thema finden sich bei \VglZitat{mustermann2023}{33-35}.
\end{itemize}

% Das Literaturverzeichnis wird automatisch am Ende des Dokuments erstellt,
% wenn Sie in der Main.tex die folgenden Befehle haben:
